...
* if you used `pkgdown::build_site_github_pages()` and pushed everything to GitHub, it might not automatically deploy your site to GH pages. I tried to go to *Settings -> Pages -> Deploy from a branch -> main -> /docs*, this makes Action deploy your site from the `docs` folder. This option requires that you create `.nojekyll` file yourself. 
